...
function getVoxPref_regress_maxminPatch(isub,numregions, con, pairType, imgType)

% condition = {'old', 'ori', 'control'}; %1, 2, 3
...
for iregion=1:numregions
    ...
    load(fullfile(curPrf,[variableName, 'regressPrfSplit' bandpassStr '_v' num2str(visualRegion) '_sub' num2str(isub)  '.mat']), ...
        'nsd',...
    ...
    allaicOriSplit{iregion} = nsd.aicOriSplit{iroi};
    allbicOriSplit{iregion} = nsd.bicOriSplit{iroi};
...
save([curPrf variableName 'voxModelPref_regress_sub' num2str(isub) '.mat'],'allRoiPrf',...
    'roiOri','roiNsdOriR2', 'allaicOriSplit', 'allbicOriSplit',...
