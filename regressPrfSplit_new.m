...
for visualRegion=visualRegions
    ...
    load(fullfile(boxfolder,['prfSampleStim_ori2_v' num2str(visualRegion) '_sub' num2str(isub) '.mat']),'prfSampleLevOri',...
...
%     synth.voxOriResidual = voxOriResidual;
    ...
    save(fullfile(boxfolder,['regressPrfSplit2' bandpassStr '_v' num2str(visualRegion) '_sub' num2str(isub) '.mat']), ...
        'nsd',...
