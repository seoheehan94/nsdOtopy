...
for iregion=1:numregions
    ...
    load(fullfile(prffolder,['regressPrfSplit2' bandpassStr '_v' num2str(visualRegion) '_sub' num2str(isub)  '.mat']), ...
        'nsd',...
...
save([prffolder 'voxModelPref2_sub' num2str(isub) '.mat'],'allRoiPrf','roiLevVig','roiLevFull',...
